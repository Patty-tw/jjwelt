        ...
        <div className="grid grid-rows-2 gap-5 sm:px-5">
            <div className="grid grid-cols-2">
                ...
                <div className="my-auto sm:ml-5">
                    ...
                    <p className="w-3/4">Our silica gel is Directive 2011/65/EU certified and does not contain Lead, Mercury, Cadmium and hazardous materials set by RoHS.</p>
                </div>
            </div>
            <div className="grid grid-cols-2">
                ...
                <div className="my-auto sm:ml-5">
                    ...
                    <p className="w-3/4">Sizes: We are able to produce sizes ranging from 1g, 2g, 3G, 4G, 5g, 6g, 10g, 20g, 30g, 50g, 100g, 200g, 500g, 1000g.
