...
export default function Hero() {
    return (
        <>
            <div className="bg-shoemaking p-20 bg-center">
                <div className="items-center w-4/5 m-auto p-10 bg-white">
                    <h1 className="text-4xl font-medium text-center">About Our Company</h1>
                    <br />
                    <p className="m-3 text-xl text-center mx-auto md:max-w-md lg:max-w-2xl">Our company specializes in leather welts and shoe-related components and has been a trusted supplier
