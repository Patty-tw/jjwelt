                ...
                <div className="basis-full mt-3 pb-3">
                    ...
                    <div className="flex items-center">
                        <div className="basis-1/2">
                            <br />
                            <p className="text-2xl">Opening hours: 9am - 5pm</p>
                            <p className="text-2xl mt-2">No. 3, Alley 2, Lane 569, Caoxi Rd, <br />
                                Caotun Township, <br />
                                Nantou County, Taiwan</p>
                            <p className="text-2xl mt-2">+886 970417511</p>
                        </div>
                        <div className="basis-1/2">
                            <br />
                            <iframe className="w-full aspect-auto"
                ...
                <div className="basis-full mt-3 pb-3">
                    ...
                    <div className="flex items-center">
                        <div className="basis-1/2">
                            <br />
                            <p className="text-2xl">Opening hours: 9am - 5pm </p>
                            <p className="text-2xl mt-2">Pingnan Industrial Area <br />
                                Pingzhou, Nanhai District, Foshan City <br />
                                Guandong, China
                            </p>
                            <p className="text-2xl mt-2">+86 139-277-55394</p>
                        </div>
                ...
                <div className="basis-full mt-3 pb-3">
                    ...
                    <div className="flex items-center">
                        <div className="basis-1/2">
                            <br />
                            <p className="text-2xl">Opening hours: 9am - 5pm</p>
                            <p className="text-2xl mt-2">DT 743, Song Than Industrial Area <br />
                                Binh Duong, Vietnam</p>
                            <p className="text-2xl mt-2">+84 916-810445</p>
                        </div>
