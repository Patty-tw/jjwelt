  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-[60px] p-10 justify-items-center lg:px-10">
        <img src="./images/S__4333754.jpg" alt="leather-welt-1" />
        <img src="./images/S__4333738.jpg" alt="leather-welt-1" />
        ...
        />
        <img
          src="./images/CnNIanpVejakSBj.png"
          alt="leather-welt-4"
          className="aspect-square object-center object-contain"
        />
        <img
          src="./images/CRPOwLMqiOOuSmJ.png"
          alt="leather-welt-5"
          className="aspect-square object-center object-contain"
        />
        <img
          src="./images/iTDWxdvHLpmkZjb.png"
          alt="leather-welt-6"
          className="aspect-square object-center object-contain"
        />

        <img
          src="./images/IXzSRZycobRpOOV.png"
          alt="leather-welt-7"
          className="aspect-square object-center object-contain"
        />
        <img
          src="./images/EOgCbjABBeWsTEx.png"
          alt="leather-welt-8"
          className="aspect-square object-center object-contain"
        />
        <img
          src="./images/eBgxvBjewhHBbyx.png"
          alt="leather-welt-9"
          className="aspect-square object-center object-contain"
        />

        <img
          src="./images/OcvqIQOYngRFAqA.png"
          alt="leather-welt-10"
          className="aspect-square object-center object-contain"
        />
        <img
          src="./images/grPZLOIxvhRXkmb.png"
          alt="leather-welt-11"
          className="aspect-square object-center object-contain"
        />
        <img
          src="./images/tezaREhTDilgpgg.png"
          alt="leather-welt-12"
          className="aspect-square object-center object-contain"
        />
        <img
