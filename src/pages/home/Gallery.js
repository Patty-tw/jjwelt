            ...
            <div className="grid grid-cols-auto-fit gap-10 p-10">
                <div className="max-w-sm rounded overflow-hidden shadow-lg object-cover object-center" >
                    <Link to="/leather-welt" >
                        ...
                        <p className="flex font-bold text-xl items-center justify-center h-20">Leather Welt</p>
                ...
                <div className="max-w-sm rounded overflow-hidden shadow-lg">
                    <Link to="/leatherboard-welt">
                        ...
                        <p className="flex font-bold text-xl items-center justify-center h-20">Leatherboard Welt</p>
                    </Link>
                ...
                <div className="max-w-sm rounded overflow-hidden shadow-lg">
                    <Link to="/plastic-welt">
                        ...
                        <p className="flex font-bold text-xl items-center justify-center h-20">Plastic Welt</p>
                    </Link>
                ...
                <div className="max-w-sm rounded overflow-hidden shadow-lg">
                    ...
                    <Link to="/stacked-leather" >
                        ...
                        <p className="flex font-bold text-xl items-center justify-center h-20">Stacked Leather</p>
                    </Link>
                </div>
                <div className="max-w-sm rounded overflow-hidden shadow-lg">
                    ...
                    <Link to="/outsole-stock-fitting">
                        ...
                        <p className="flex font-bold text-xl items-center justify-center h-20">Outsole Stock Fitting</p>
                    </Link>
                </div>
                <div className="max-w-sm rounded overflow-hidden shadow-lg">
                    <Link to="/desiccant">
                        ...
                        <p className="flex font-bold text-xl items-center justify-center h-20">Desiccant</p>
                    </Link>
                </div>
            </div>
        </div>
